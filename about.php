...
<html lang="zh-TW">
<head>
    <title>關於我們 | 洛嬉遊戲 L.S. Games</title>
            ...
            <div class="container">
                ...
                <div class="about-main">
                    <div class="about-w3-left">
                        <div class="about-img" style="background: url(images/about.jpg) !important;">
                        </div>
            ...
            <div class="container">
                ...
                <div class="col-md-6 team-right">
                    <div class="col-md-6 col-sm-6 col-xs-6 team-grid">
                        <img class="team-img img-responsive" src="images/writer.jpg" alt="">
                        <h6>劇本編寫</h6>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6 team-grid t2">
                        <img class="team-img img-responsive" src="images/programmer.jpg" alt="">
                        <h6>程式設計</h6>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6 team-grid">
                        <img class="team-img img-responsive" src="images/art.jpg" alt="">
                        <h6>平面美術設計</h6>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6 team-grid">
                        <img class="team-img img-responsive" src="images/modeling.jpg" alt="">
                        <h6>立體建模設計</h6>
                        <div class="clearfix"> </div>
                    </div>
                </div>
