...
<?php } else { ?>
    <div class="dropdown pull-right" style="display: inline-block; ">
        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            <?php echo $_SESSION['user']; ?>&nbsp;&nbsp;<span class="badge"><?php echo $notifyunreadnums; ?></span>
            <span class="caret"></span>
        </button>
        <ul class="dropdown-menu pull-right" aria-labelledby="dropdownMenu1">
            <li class="dropdown-header">使用者選單</li>
            <li><a href="notification.php?action=viewnotifies"><span class="badge"><?php echo $notifyunreadnums; ?></span>&nbsp;則通知</a></li>
