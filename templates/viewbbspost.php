<?php
if (empty($_GET['bid'])) { ?>
    <h2 class="news-warn">找不到此討論板！<br /><a href="?action=viewboard" class="btn btn-lg btn-info">按此返回討論板一覽</a></h2>
...
<div class="container">
    <div class="row">
        ...
        <?php
            ...
            <?php } ?>
            <?php }else{ ?>
                <h2 class="news-warn">討論板目前無文章<br /><br /><a href="?action=addnewpost&boardid=<?php echo $bid; ?>" class="btn btn-lg btn-success">按此張貼新文章</a></h2>
            <?php } ?>
    </div>
</div>